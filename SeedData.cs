...
namespace EF_Core_Project
{
    public static class SeedData
    {
        ...
        {
            new Individual { Id = 1, FName = "Fatima", LName = "Ali",University = "XYZ", YearOfGrad = 2024, IsIntern = false },
            new Individual { Id = 3, FName = "Omar", LName = "Youssef", University = "POQ", YearOfGrad= 2023, IsIntern = true },
            new Individual { Id = 5, FName = "Amira", LName = "Tariq", University = "POQ", YearOfGrad = 2025, IsIntern = false },
            new Individual { Id = 6, FName = "Zainab", LName = "Ismail", University = "POQ", YearOfGrad = 2023, IsIntern = true },
            new Individual { Id = 9, FName = "Mohammed", LName = "Adel", University = "XYZ", YearOfGrad = 2024, IsIntern = false },
            new Individual { Id = 10, FName = "Samira", LName = "Nabil", University = "XYZ", YearOfGrad = 2024, IsIntern = false }
        };
